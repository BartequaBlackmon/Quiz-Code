// Start the quiz with the timer set to 75. Timer left will be the final score.
var timeLeft = 75;
var timeId;
...
// This is the question functions that contain questions and answers. They are in multidimensional array with inner arrayelements
var questions = [
  {
  ...
  },
  {
      ...
      answers: [
          { test: "Washington DC", correct: false },
  ...
  },
  {
      ...
      answers: [
          ...
          { texr: "13", correct: true }
      ]
  },
  {
      question: "In what year did the United States of America gained her independence?",
      answers: [
...
// Start Quiz
function startGame() {
  timeId = setInterval(timeTick, 1000);
